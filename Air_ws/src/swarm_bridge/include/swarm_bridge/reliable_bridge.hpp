...
public:
     ...
     */
    ReliableBridge(const int self_ID, vector<string> &IP_list, vector<int> &ID_list, uint Queue_size = 10000) : self_id(self_ID), ip_list(IP_list), id_list(ID_list), queue_size(Queue_size), thread_flag(true)
    {
