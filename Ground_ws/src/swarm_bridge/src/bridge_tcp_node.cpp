...
double map_freq_ = 2;
double odom_freq_ = 20;
double blind_freq_ = 20;
...
// Here is callback when the bridge received the data from others.
...
int main(int argc, char **argv)
{
  ...
  ros::Subscriber delta_time_sub = nh.subscribe("delta_time_topic", 1, delta_time_callback, ros::TransportHints().tcpNoDelay());
