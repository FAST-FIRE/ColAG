...
namespace ego_planner
{
                                        ...
                                        Eigen::Vector3d local_target_vel, bool flag_polyInit, bool flag_randomPolyTraj)
  {
    ...
    // generateVisbilityRegion
    // 记录生成的区域的时间、参数，约束在最近时间的区域内
    bspline_optimizer_->generateVisbilityRegion(ts, start_pt);
    visualization_->visualize_fan_shape_meshes(bspline_optimizer_->target_ps,
                                               bspline_optimizer_->visible_ps,
                                               bspline_optimizer_->thetas);
    ...
    count_success++;
    cout << "total time:\033[42m" << sum_time << "\033[0m,init:" << t_init.toSec() << ",optimize:" << t_opt.toSec() << ",refine:" << t_refine.toSec() << endl; //",avg_time=" << sum_time / count_success <<
