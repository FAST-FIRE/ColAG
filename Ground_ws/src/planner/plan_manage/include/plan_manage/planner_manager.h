...
namespace ego_planner
{
  ...
  public:
    ...
    void deliverMasterTrajToOptimizer(void) { bspline_optimizer_->setMasterTraj(&master_traj_buf_); };
    void serFormationToOpt(Eigen::Vector3d dir, Eigen::Vector3d pos)
    {
      bspline_optimizer_->setDirection(dir);
      bspline_optimizer_->setFormation(pos);
    };
    ...
    OneTrajDataOfSwarm master_traj_buf_;
