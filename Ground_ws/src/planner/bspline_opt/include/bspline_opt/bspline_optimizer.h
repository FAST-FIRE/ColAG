...
namespace ego_planner
{
  ...
  public:
    ...
    void setMasterTraj(OneTrajDataOfSwarm *traj_ptr);
    void setDirection(Eigen::Vector3d dir);
    void setFormation(Eigen::Vector3d pos);
    ...
    std::vector<Eigen::Vector3d> target_ps;
    ...
    void generateVisbilityRegion(const double &ts, const Eigen::Vector3d &start_pt);
    inline bool checkRayValid(const Eigen::Vector3d& p0, const Eigen::Vector3d& p1);
  ...
  private:
    ...
    OneTrajDataOfSwarm  *master_traj_ = NULL;
    int drone_id_;

    Eigen::Vector3d formation_pos_;
    Eigen::Vector3d formation_dir_;
    ...
    Eigen::Vector3d  max_vel_vec_, max_acc_vec_;

    double desired_dist_, tolerance_dist_, tolerance_theta_, visible_T;//about visibility
...
#define INIT_min_ellip_dist_ 123456789.0123456789
    ...
    void calcVisibilityCost(const Eigen::MatrixXd &q, double &cost, Eigen::MatrixXd &gradient);
    ...
    void calcFormationCost(const Eigen::MatrixXd &q, double &cost, Eigen::MatrixXd &gradient);
